...
* Cordova/Electron feature release 2.1.0 IN DEVELOPMENT

? ??,2019  | **Release 2.1.0** | available from [npm](https://www.npmjs.com/package/generator-full-stack-api/v/2.1.0)  |
---- | ---- | ---- |
